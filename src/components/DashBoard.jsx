...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const response = await axios.get('https://api.organicmatki.in/orders/fetchorders');
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      <h1 className="text-lg md:text-2xl font-bold mb-4">Organic Matki Admin Dashboard</h1>
